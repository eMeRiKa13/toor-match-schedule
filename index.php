...
// Import Matches
if(!empty($_POST) && $_POST['import_matches'] == 1) {

    // Get Access Token
    include_once('oauth.php');
    $access_token = getAccessToken(trim($_POST['api_client_id']), trim($_POST['api_client_secret']), trim($_POST['api_key']));
...
<div id="content" class="clearfix">
    ...
    <form method="post" action="" class="pure-form">
                ...
                <?php if(isset($matches)) : foreach($matches as $match) : ?>
                    ...
                    <tr>
                        <td style="text-align: left;">
                            <span style="font-size: 12px;">Stage <?php echo $match->stage_number; ?> / Group <?php echo $match->group_number; ?> / Round <?php echo $match->round_number; ?></span><br />
                            <strong>
        ...
        <div id="config">
            ...
            <p>
                <label>API Key</label>
                <input type="text" name="api_key" value="<?php if(isset($_POST['api_key'])) echo $_POST['api_key']; ?>" autocomplete="off" />
            </p>

            <p>
                <label>API Client ID</label>
                <input type="text" name="api_client_id" value="<?php if(isset($_POST['api_client_id'])) echo $_POST['api_client_id']; ?>" autocomplete="off" />
            </p>

            <p>
                <label>API Client Secret</label>
                <input type="text" name="api_client_secret" value="<?php if(isset($_POST['api_client_secret'])) echo $_POST['api_client_secret']; ?>" autocomplete="off" />
            </p>
            ...
            <p>
                ...
                <select name="timezone">
                    <?php if(isset($_POST['timezone'])) : ?>
                        <option selected="selected" value="<?php echo $_POST['timezone']; ?>"><?php echo $_POST['timezone']; ?></option>
                    <?php endif; ?>
